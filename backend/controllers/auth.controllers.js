...
export const signOut = async (req, res) => {
  try {
    res.clearCookie("token"); // fixed from clearCookies → clearCookie
...
export const verifyOtp = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: `verify otp error : ${error.message}` });
  }
};
...
export const resetPassword = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: `password reset error : ${error.message}` });
  }
};
...
export const googleAuth = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: `googleAuth error : ${error.message}` });
  }
};
